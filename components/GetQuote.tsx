  ...
  return (
    <section id="contact" className="py-20 bg-white text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8 px-6 mb-12">
        {[
          { title: "1. Contact Us", text: "Reach out via call or WhatsApp to discuss your project." },
          { title: "2. Site Visit", text: "We visit your site. Fuel cost may apply depending on location. Free within Ongata Rongai and nearby areas." },
          { title: "3. Project Assessment", text: "We evaluate your needs and recommend the best approach." },
          { title: "4. Planning & Design", text: "We prepare architectural, structural plans and BOQ." },
          { title: "5. Payment Plan", text: "Flexible options based on your project scope." },
          { title: "6. Execution", text: "Construction or service delivery begins." },
        ].map((step, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 40 }}
      ...
      <motion.button
        ...
        className="bg-orange-500 text-white px-8 py-4 rounded-lg font-semibold text-lg"
      >
